...
@section('content')
    <div class="row mb-4">
        <div class="col-sm-6 mt-3">
            <a href="{{ route('admin.language.create') }}" class="btn btn-block btn-primary primary">Add language</a>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
                ...
                <tbody>
                  @foreach ($languages as $language)
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-default" type="button" href="{{ route('admin.language.show', $language->id) }}"><i class="far fa-eye"></i></a>
                      </td>
                      <td>
